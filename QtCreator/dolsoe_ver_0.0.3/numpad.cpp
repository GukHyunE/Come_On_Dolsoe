...
void NumPad::updateLanguage(const QString &language)
{
    if (language == "KR") {
        ui->backButton->setText("지움");
        ui->enterButton->setText("확인");
    } else { // EN
        ui->backButton->setText("Delete");
        ui->enterButton->setText("OK");
    }
}

...
QT_MOC_LITERAL(7, 49, 7), // "restart"
QT_MOC_LITERAL(8, 57, 11), // "onReadyRead"
QT_MOC_LITERAL(9, 69, 9) // "reconnect"

    },
    "VideoWorker\0frameReady\0\0cv::Mat\0frame\0"
    "start\0stop\0restart\0onReadyRead\0reconnect"
};
...
void VideoWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->stop((*reinterpret_cast< bool(*)>(_a[1]))); break;
        ...
        {
            using _t = void (VideoWorker::*)(const cv::Mat & );
...
// SIGNAL 0
void VideoWorker::frameReady(const cv::Mat & _t1)
{
